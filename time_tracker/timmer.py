...
class ActivityList:
    ...
    def get_time_entires_from_json(self,data):
        ...
        for entry in data['time_entries']:
            return_list.append(
                TimeEntry(
                    start_time = parser.parser(entry['start_time']),
                    end_time = parser.parser(entry['end_time']),
                    days = entry['days'],
                    hours = entry['hours'],
...
class TimeEntry:
    ...
    def __init__(self,start_time,end_time,days,hours,minutes,seconds,user_end_time):
        ...
        self.total_active_time = time.time() - last_time
    ...
    def _get_specific_times(self):
        ...
        self.active_total_time = str(datetime.timedelta(seconds=self.total_active_time))
    ...
    def serialize(self):
        return {
            ...
            'tab_open_time':self.active_total_time,
        }
    last_time
